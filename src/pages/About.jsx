...
const capabilities = [
  {
    ...
    text: "Modern, responsive and SEO-friendly business websites.",
  },
  {
    icon: MonitorSmartphone,
    title: "App Development",
    text: "Useful and user-friendly mobile and web applications.",
  },
  {
    icon: Megaphone,
    title: "Digital Promotion",
    text: "Campaigns created to increase your online business reach.",
  },
  {
    icon: Palette,
    title: "Creative Design",
    text: "Posters, social posts, advertisements and branded creatives.",
  },
  {
    icon: Search,
    title: "SEO Support",
    text: "Search-friendly structure and content for better visibility.",
  },
  {
    icon: BarChart3,
    title: "Growth Strategy",
    text: "Practical digital strategies based on your business objectives.",
  },
];
...
export default function About() {
  return (
    <main className="about-page">
      <PageHero
        eyebrow="About     Tech Digital Designer"
        title="Creative ideas, useful technology and real business growth"
        text="Tech Digital Designer is a digital growth studio helping businesses, professionals and startups build trust, attract customers and grow through modern websites, applications, marketing and creative design."
      />
      ...
      <section className="section about-introduction">
        <div className="container about-intro-layout">
          <div className="about-intro-content">
            ...
            <p>
              Tech Digital Designer helps businesses create a
              powerful and trustworthy digital
              presence. We provide website
              development, application development,
              digital marketing, social media
              promotion, branding, poster design,
              advertising creatives and other digital
              services.
            </p>

            <p>
              Our purpose is not limited to creating
              attractive designs. We first understand
              your business, customers and objectives,
              then develop a practical solution that
          ...
          <div className="about-visual">
            <div className="about-visual-main">
              ...
              <span>Tech Digital Designer</span>
              ...
              <p>
                We transform business ideas into
                useful, attractive and growth-focused
                digital experiences.
              </p>
        ...
        <div className="container">
          <div className="about-mission-grid">
            <article className="about-mission-card">
              ...
              <h2>
                Make professional digital services
                accessible
              </h2>

              <p>
                Our mission is to provide reliable,
                affordable and result-focused digital
                services to startups, professionals
            ...
            <article className="about-mission-card about-vision-card">
              ...
              <h2>
                Help every business grow confidently
                online
              </h2>

              <p>
                Our vision is to become a trusted
                digital partner that converts ideas
                into modern and valuable online
                experiences.
              </p>
            </article>
          </div>
      ...
      <section className="section about-capabilities-section">
        <div className="container">
          <div className="about-center-heading">
            ...
            <h2>
              Complete services under one digital
              studio
            </h2>

            <p>
              You do not need separate developers,
              designers and marketers. Tech Digital Designer
              provides complete digital support in one
              place.
            </p>
          </div>
        ...
        <div className="container">
          <div className="about-section-heading">
            <div>
              ...
              <h2>
                Principles behind everything we create
              </h2>

              <p>
                Our values guide how we communicate,
                design, develop and support every
                client project.
              </p>
            </div>
          </div>
              ...
              return (
                ...
                >
                  <div className="about-value-top">
                    ...
                    <span>Tech Digital Designer Value</span>
                  </div>
      ...
      <section className="section about-advantages-section">
        <div className="container about-advantages-layout">
          <div className="about-advantages-content">
            <span className="eyebrow">
              Why Choose Tech Digital Designer?
            </span>

            <h2>
              Digital services created around your
              business
            </h2>

            <p>
              We balance visual design, performance,
              security, user experience and business
          ...
          <div className="about-advantages-panel">
            ...
            <h3>
              We work like a digital partner, not just
              a service provider
            </h3>

            <p>
              From initial planning and development to
              launch and maintenance, we keep the
              complete process clear and understandable.
            </p>
      ...
      <section className="section about-process-section">
        <div className="container">
          <div className="about-center-heading">
            ...
            <p>
              Every project follows an organized
              process so you always know what is being
        ...
        <div className="container">
          <div className="about-technologies-heading">
            <div>
              <span>Modern Technology</span>
              <h2>
                Tools we use to create reliable
                digital products
              </h2>
            </div>
      ...
      <section className="section about-support-section">
        <div className="container about-support-card">
          ...
          <div className="about-support-content">
            ...
            <h2>
              Your project continues to receive the
              support it needs
            </h2>
            ...
            <p>
              ...
              according to your selected service or
              plan.
            </p>
          </div>
      ...
      <section className="about-final-cta">
        <div className="container about-final-cta-content">
          <div>
            ...
            <p>
              Tell us about your business, budget and
              requirements. We will help you choose the
